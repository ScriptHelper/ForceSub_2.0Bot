...
async def settings(bot: Client, msg):
    ...
    await msg.reply(
        "**Settings** \n\n"
        "1) Choose an action type for those who haven't joined the force subscribe chat. It defaults to mute.\n"
        ...
        "3) Determine whether admins should be able to change Fsub chat and settings. Only the owner by default.",
