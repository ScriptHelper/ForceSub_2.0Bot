        ...
        try:
            ...
            try:
                ...
                if action == 'kick':
                    ...
                    await msg.reply("Member was kicked out because he had not joined the Forces Subscribe Chat")
                    return
                elif action == 'ban':
                    await msg.chat.kick_member(user_id)
                    await msg.reply("Member was barred from joining the forces because he refused to join Force Subscribe Chat")
                    return
